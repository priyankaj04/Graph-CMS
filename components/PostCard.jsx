            ...
            <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
                  <div className='relative overflow-hidden shadow-md pb-80 mb-6'>
                        <img
                              ...
                              alt={post.title}
                              className = 'pbject-top absolute h-80 w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg'
                        />
                        
                  </div>
                  <h1 className='transition duration-700 text-center mb-8 cursor-pointer hover:text-green-800 text-3xl font-semibold'>
                  ...
                  <div className='block lg:flex test-center items-center justify-center mb-8 w-full'>
                        ...
                        <div className='font-medium text-gray-700'>
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-green-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
